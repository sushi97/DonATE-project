...
public class ngo_receiver extends AppCompatActivity{
...
//        });
        ...
        call2.enqueue(new Callback<List<ngolist>>() {
            ...
            public void onResponse(Call<List<ngolist>> call, Response<List<ngolist>> response) {
                ...
                adapter = new recyclerAdapter(finallist, ct);
...
//    @Override
//    public void onListItemClick(final int itemClickedIndex) {
...
//                    Log.e("TAG", finallist.get(itemClickedIndex).getName() + ":::" + itemClickedIndex);
